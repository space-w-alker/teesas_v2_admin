...
const TestDetails = ({ isOpen }) => {
  return (
    <div className={`py-[7rem] lg:px-[5rem]  px-[10px] ${isOpen ? "xl:ml-[260px]" : ""}`}>
      ...
      <div className="bg-[#EFF6F1] border rounded-lg mt-7  mb-[20px] border-[#CAC4D0] h-[68px] p-[8px]">
      ...
      <div>
        {/* <p className=' text-[14px] leading-[20px] text-center text-[#27AE60] cursor-pointer'>Manage</p>*/}
      </div>
