...
const StudentManagement = ({ isOpen }) => {
  ...
  useEffect(() => {
    ...
    getStudentsLiveClassesAsync({
      ...
      token: token,
      callbackFn: (res) => {
        setAdminData(res?.data?.data?.students);
              ...
              <li key={i}>
                <div className=" md:flex lg:flex justify-between  items-center gap-4">
                      ...
                      <div className="flex items-center gap-3 ">
                        <div className="flex items-center  gap-2  cursor-pointer">
                          <p className=" font-normal text-[12px] leading-[15px] text-[#000000] ">
                            {user?.user?.academies?.academy_name}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center">
                    <Custombutton
                      value={user?.user?.status == 1 ? "Visible" : "Hidden"}
                      img={sharp}
                      backgroundcolor={
                        user?.user?.status == 1 ? "bg-[#E9FDEE]" : "bg-[#565656]"
                      }
                      textcolor={
                        user?.user?.status == 1 ? "text-[#2760EA]" : "text-[#707070]"
                      }
                      imagePosition="left"
                    />
