          ...
          <div className="users bg-[#FFFFFF] rounded-xl lg:w-[80%]">
            ...
            <div className=" p-2 py-[20px] ">
              <form > 
                <div>
                <div className="">
                    <label for="Old_Password" className="font-medium text-[14px] leading-[18px] text-[#3D3D3D] ">
                     Old Password
                    </label>
                    <input
                      type="password"
             ...
             <div className="block lg:grid grid-cols-2 gap-5 mt-5">
                  ...
                  <div className="">
                    <label for="Confirm_Password" className="font-medium text-[14px] leading-[18px] text-[#3D3D3D] ">
                      Confirm Password
                    </label>
                    <input
                      type="password"
          ...
          <div className="text-[16px] leading-[24px] text-[#000000]">{value}</div>
            ...
            <div className="bg-[FFF9FD] m-auto my-10">
              <button onClick={() => {
               ...
               }} type="button" className=" h-[32px] rounded-lg text-center  w-[200px]  text-white bg-[#F2994A]">Create</button>
            </div>
          </div>
  </div>
  </div>
