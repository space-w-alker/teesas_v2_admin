...
const SupportTicketDetails = ({ isOpen }) => {
  ...
  return (
    <div className={`py-[7rem] lg:px-[5rem]  flex flex-col gap-2 px-[10px] ${isOpen ? "lg:ml-[260px]" : ""}`}>
      ...
      <div className="bg-[#EFF6F1] border rounded-lg  mt-4 mb-[20px] border-[#CAC4D0] h-[68px] p-[8px]">
      ...
      <div>
        <p className=' text-[14px] leading-[20px] text-center text-[#27AE60] cursor-pointer'>View Profile</p>
      </div>
      <Message />
    </div>
  )
