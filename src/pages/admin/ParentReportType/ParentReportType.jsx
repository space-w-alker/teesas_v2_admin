  ...
  return (
    <div
      ...
      <div className=" flex  justify-end mt-4 ">
        <button className="text-[14px] leading-[20px] text-center font-bold  w-[250px] h-[40px] rounded-lg py-[7px] px-[12px] bg-[#27AE60] text-white" onClick={() => Navigate('/AddParentReportType')}>
