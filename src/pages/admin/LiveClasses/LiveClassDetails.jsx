...
const LiveClassDetails = ({ isOpen }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#EFF6F1] mt-5 border rounded-lg lg:mb-[20px] border-[#CAC4D0] h-[60px] p-[8px]">
        <div className="flex items-center gap-4">
          ...
          <div className="">
            <p className=" font-bold text-[16px] leading-[24px] lg:pb-0  tracking-wider text-[#1D2026]">
              {adminData?.topic} - {adminData?.subject?.name}
            </p>
            <div>
              {/* <Custombutton
      ...
      <div>
        <div className="flex items-center justify-end">
          <button
            ...
            className=" border  rounded-[8px] bg-[#34C759] text-white   text-[14px] leading-[20px]  pt-[2px]  w-[128px] h-[40px] text-center cursor-pointer"
          >
            Launch Class
          </button>
        </div>
