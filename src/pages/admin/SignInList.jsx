...
const SignInList = ({ isOpen }) => {
  ...
  const totalUsersGraph = [
    { y: 10, height: 20, label: "May" },
    { y: 13, height: 25, label: "Jun" },
    { y: 11, height: 22, label: "Jul" },
    { y: 14, height: 26, label: "Aug" },
    { y: 50, height: 75, label: "Sep" },
    { y: 55, height: 80, label: "Oct" },
    { y: 60, height: 90, label: "Nov" },
    { y: 17, height: 27, label: "Dec" },
    { y: 35, height: 55, label: "Jan" },
    { y: 58, height: 88, label: "Feb" },
    { y: 65, height: 95, label: "Mar" },
    { y: 70, height: 100, label: "Apr" },
  ];

  const activeUsersGraph = [
    { y: 7, height: 18, label: "May" },
    { y: 9, height: 20, label: "Jun" },
    { y: 8, height: 19, label: "Jul" },
    { y: 10, height: 21, label: "Aug" },
    { y: 40, height: 65, label: "Sep" },
    { y: 44, height: 68, label: "Oct" },
    { y: 50, height: 72, label: "Nov" },
    { y: 14, height: 22, label: "Dec" },
    { y: 30, height: 45, label: "Jan" },
    { y: 53, height: 78, label: "Feb" },
    { y: 60, height: 85, label: "Mar" },
    { y: 67, height: 93, label: "Apr" },
  ];

  const subscribedUsersGraph = [
    { y: 5, height: 15, label: "May" },
    { y: 6, height: 16, label: "Jun" },
    { y: 7, height: 17, label: "Jul" },
    { y: 9, height: 18, label: "Aug" },
    { y: 35, height: 55, label: "Sep" },
    { y: 38, height: 58, label: "Oct" },
    { y: 43, height: 63, label: "Nov" },
    { y: 12, height: 20, label: "Dec" },
    { y: 27, height: 40, label: "Jan" },
    { y: 48, height: 70, label: "Feb" },
    { y: 55, height: 78, label: "Mar" },
    { y: 62, height: 85, label: "Apr" },
  ];

  const totalOrdersGraph = [
    { y: 3, height: 13, label: "May" },
    { y: 4, height: 14, label: "Jun" },
    { y: 5, height: 15, label: "Jul" },
    { y: 6, height: 16, label: "Aug" },
    { y: 30, height: 50, label: "Sep" },
    { y: 34, height: 54, label: "Oct" },
    { y: 38, height: 60, label: "Nov" },
    { y: 10, height: 18, label: "Dec" },
    { y: 22, height: 35, label: "Jan" },
    { y: 40, height: 65, label: "Feb" },
    { y: 50, height: 75, label: "Mar" },
    { y: 58, height: 82, label: "Apr" },
  ];
  const data = [
    {
      name: "Allyson Stairs",
