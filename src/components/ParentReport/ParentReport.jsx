...
import ParentFeedbacklist from "../../components/ParentReport/ParentFeedbacklist";
            ...
            <div className="flex justify-start  items-center lg:gap-3">
                ...
                <div>
                    <div className=" font-normal text-[14px] lg:text-[16px] leading-[20px] text-[#B6B6B6]">
                        Home /<span className="text-black font-medium"> Parent Feedback</span>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div className="lg:flex gap-[10px]  justify-between mt-5 ">
                    ...
                    <div className="p-[10px] bg-[#FFFFFF] flex flex-col gap-2  lg:mt-0 mt-5  w-full lg:h-[72px]  py-[10px]  px-[15px] rounded-xl">
                        <div className="">
                            <p className="text-[12px] leading-[12px] text-[#001D4A] mt-2">
                                Total Resolved Parent Feedback
                            </p>
                        </div>
                        <div>
                            <p className="font-meduim text-[20px] leading-[20px]">
        ...
        >
          ...
          >
            ...
            <div className="mt-[60px]">
                <ParentFeedbacklist feedbackType="parent_feedback" />
                {isModalOpen && (
                    <Modal
                        csvData1={csvUser}
