...
const PracticeUnitMediaUpload = ({ isOpen }) => {
    ...
    <div className={`py-[7rem] lg:px-[5rem] px-[10px] ${isOpen ? "xl:ml-[260px]" : ""} transition-all duration-300`}>
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-gray-900 font-medium">Add Practice</span>
        </div>
      </div>
      ...
      <div className="flex gap-6">
        <div className="flex-[2] bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-xl font-bold text-gray-900">Add Practice</h2>
          </div>
      ...
      <Popup open={showSuccess} closeOnDocumentClick={false} modal>
        <div className="bg-white rounded-xl p-8 text-center">
          ...
          <h2 className="text-xl font-bold mb-6">Practice Created Successfully</h2>
          <button
            onClick={handleClose}
...
export default PracticeUnitMediaUpload;
