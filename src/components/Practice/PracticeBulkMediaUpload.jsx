...
const PracticeBulkMediaUpload = ({ isOpen }) => {
      ...
      <div className='flex justify-start items-center lg:gap-3'>
        ...
        <div>
          <div className='font-normal text-[14px] lg:text-[16px] leading-[20px] text-[#B6B6B6]'>
            Practice /<span className='text-black font-medium'> Upload Bulk Media</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 bg-white rounded-xl p-6 flex">
        <div className="flex-1">
          ...
          >
            ...
            <button
              ...
              className="mt-4 text-[#27AE60] font-medium hover:text-[#219652]"
            >
        ...
        <div className="ml-8 w-1/3 bg-[#E9FDEE] rounded-xl p-6">
          ...
          <button
            ...
            disabled={!file}
            className="w-full py-3 rounded-lg text-white bg-[#27AE60] hover:bg-[#219652] mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Upload Media
          </button>
        </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-8 w-[400px] text-center">
            ...
            <p className="text-gray-600 mb-8">Media files uploaded successfully</p>
            <button
              onClick={handleClose}
...
export default PracticeBulkMediaUpload;
