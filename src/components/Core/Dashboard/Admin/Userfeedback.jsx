...
const [sortKey, setSortKey] = useState('Latest');
  ...
  return (
    <>
    <div
    className={`flex justify-end items-center relative mt-3`}
  >
  {loading && (
    <div
      style={{
    ...
    <div className="py-[2px]  rounded-[18px] bg-[#FFFFFF] ">
                    ...
                    <div className="flex flex-col gap-2 " key={index}>
                      <div className="flex  items-center gap-3 px-[18px] mt-3">
                        <div
                          ...
                          onClick={() => {
                            Navigate(`/UserFeedBackDetails?id=${item?.id}`);
                          }}
                        >
                          <p>{item?.Users?.first_name}</p>
                          <p>{item?.Users?.last_name}</p>
                          <p>{item?.Users?.userCourses[0]?.classes?.name}</p>
                        </div>
                      </div>
      ...
      {isModalOpen && <Modal closeModal={handleModalClose}  value1="Filter By Course"
      ...
      {isModalFilterOpen && <Modal closeModalWithClick1={latestOnClick}
      closeModalWithClick2={oldestOnClick} closeModal={handleModalClose} label="Sort By" />}
    </div>
    </>
  );
};
