...
const AddBulkSummerCampParticipant = ({ isOpen }) => {
  ...
  return (
    <div className={`py-[7rem] lg:px-[5rem] px-[10px] ${isOpen ? "xl:ml-[260px]" : ""} transition-all duration-300`}>
      <Headers value1="Home" value2="Add Bulk Summer Camp Participants" />

      <div className="flex gap-6">
        <div className=" mt-6 flex-[2] bg-white rounded-xl shadow-sm p-6">
          <Headcomponent value="Upload Multiple Participants" showSearch={false} />
          <div
      ...
      <SuccessModal
        ...
        message="Your participants list has been uploaded successfully"
        buttonText="Close"
      />
    </div>
  );
...
export default AddBulkSummerCampParticipant;
