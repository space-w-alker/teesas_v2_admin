...
const Sidebar = ({ isOpen }) => {
  ...
  return (
    <div className={`w-80 side-bar bg-white fixed z-50 mt-[50px] flex flex-col py-[10px] px-[18px] overflow-scroll overflow-y-scrool height ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300`}>
