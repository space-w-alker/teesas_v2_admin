...
const UserCard = ({
  ...
  img2,
  subContent,
  growth = false, // Default false
}) => {
  return (
    <div className={`py-[15px] lg:mt-0 mt-[10px] px-[15px] rounded-xl flex gap-[8px] flex-col w-full lg:${width} ${height} ${backgroundcolor} relative`}>
      ...
      {growth && (
        <div className='absolute right-[15px] bottom-[15px] flex items-center text-green-600 text-sm gap-[5px]'>
